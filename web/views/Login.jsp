...
<html lang="en">
    ...
    <body>
                ...
                <div class="row align-items-center h-78">
                    <div class="col-md-1">
                        <div class="header-logo">
                            <a href="#"><img src="./images/headerLogo" alt=""></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="signup-body">
            <form action="logins" method="post" class="mx-auto">
                <div class="bg-white p-5 form-login">
                    ...
                    <div class="">
                        <div class="border-bottom">
                            ...
                            <div class="d-flex align-items-center fs-4 mt-3">
                                ...
                                <input type="text" name="usernames" value="" placeholder="Username" class="w-100 py-4 outline-0 border-0 ms-3" />
                            </div>
                        </div>
                        <div class="border-bottom mt-5">
                            ...
                            <div class="d-flex align-items-center fs-4 mt-3">
                                ...
                                <input type="password" value="" name="passwords" placeholder="Password" class="w-100 py-4 outline-0 border-0 ms-3" />
                            </div>
                        </div>
                    </div>
                    <div class="text-center mt-3 fs-5">
                     ...
                     <buton type="submit" class="d-flex align-items-center justify-content-center mt-5 fw-bold py-2 fs-4 px-5 btn bg-danger text-white  mx-auto">Submit</buton>
                </div>
            </form>
